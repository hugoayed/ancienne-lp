        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            <v-col sm="4" class="hidden-xs-only">
              <v-img src="@/assets/img-perso/undraw_environment_iaus.svg" class="d-block ml-auto mr-auto" max-width="350px" />
            </v-col>
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">Un produit de fou</h1>
...
<style scoped>
#download {
  background-image: url("~@/assets/img-perso/bgHome2.jpg");
