      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 font-weight-light display-2">Tarifs</h1>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Basique</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°1</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°2</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°3</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">20 €</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Normal</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°1</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°2</div>
                    ...
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°3</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">100 €</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Entreprise</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°1</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°2</div>
                    ...
                    <div class="text-uppercase blue--text">Fonctionnalité incroyable n°3</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">500 €</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
